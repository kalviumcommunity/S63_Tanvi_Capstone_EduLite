...
import { FaUser, FaBook, FaDollarSign, FaSignOutAlt, FaTachometerAlt } from 'react-icons/fa';
          ...
          <ul className="space-y-2">
            <li>
              <button
                ...
                className={`flex items-center w-full px-6 py-4 text-left text-lg rounded-lg transition-all duration-150 group ${
                  isActive('/dashboard') ? 'bg-indigo-800 shadow' : 'hover:bg-indigo-800 hover:shadow-lg'
                }`}
              >
            ...
            <li>
              <button
                ...
                className={`flex items-center w-full px-6 py-4 text-left text-lg rounded-lg transition-all duration-150 group ${
                  isActive('/profile') ? 'bg-indigo-800 shadow' : 'hover:bg-indigo-800 hover:shadow-lg'
                }`}
              >
                <FaUser className="mr-4 group-hover:scale-110 transition-transform duration-150 text-2xl" />
            ...
            <li>
              <button
                ...
                className={`flex items-center w-full px-6 py-4 text-left text-lg rounded-lg transition-all duration-150 group ${
                  isActive('/courses') ? 'bg-indigo-800 shadow' : 'hover:bg-indigo-800 hover:shadow-lg'
                }`}
              >
            ...
            <li>
              <button
                ...
                className={`flex items-center w-full px-6 py-4 text-left text-lg rounded-lg transition-all duration-150 group ${
                  isActive('/fees') ? 'bg-indigo-800 shadow' : 'hover:bg-indigo-800 hover:shadow-lg'
                }`}
              >
